...
function moveCheckImage_GRB02(n)
{
	rate = new Array(18,15,12,0);
	wii.excse = 4;
	if( n == 1 )
	{
		document.all("List01Check").style.visibility="visible";
...
switch( rate )
{
case 18: document.all("Rating").style.backgroundImage = "url(../../../COMMON/GRB/GRB-18.gif)"; break;
case 15: document.all("Rating").style.backgroundImage = "url(../../../COMMON/GRB/GRB-15.gif)"; break;
case 12: document.all("Rating").style.backgroundImage = "url(../../../COMMON/GRB/GRB-12.gif)"; break;
case 0:  document.all("Rating").style.backgroundImage = "url(../../../COMMON/GRB/GRB-All.gif)"; break;
}
}
